# # here we implement the HRP algorithm without the cluster concept.
# # Rather we reach around a weight vector.
...
#     # this could be done with an expensive recursive function
#     # but scipy's tree provides a powerful pre_order
...
#     covariance = cov[left + right, :][:, left + right]
#
#     return np.linalg.multi_dot((weight,covariance,weight)), weights
#
#
