...
## Building pyhrp from source

You'll need to build pyhrp locally in order to start editing code.
To install pyhrp from source, clone the Github
...
To contribute to pyhrp, send us pull requests.
For those new to contributing, check out Github's
[guide](https://help.github.com/articles/using-pull-requests/).

Once you've made your pull request, a member of the pyhrp
...
If you'd like to add a new feature to pyhrp, please do propose your
...
- Read the pyhrp source and enhance the documentation,
  or address TODOs
- Browse the [issue tracker](https://github.com/tschm/pyhrp/issues),
